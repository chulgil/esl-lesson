      ...
      <body className={`${gaegu.variable} ${body.variable} antialiased`}>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem("app.theme");if(t==="candy"||t==="lego"||t==="note"||t==="cat"||t==="excel"||t==="school")document.documentElement.setAttribute("data-theme",t)}catch(e){}`,
          }}
        />
        <AppNav />
        <InviteToaster />
