...
import { boardThemeOf } from "@/lib/theme-surfaces";
...
function TetrisInner() {
  ...
  // 전용 보드 스킨이 없는 테마는 노트 보드로 폴백 — 매핑은 theme-surfaces 단일 정의
  const boardTheme = boardThemeOf(effectiveTheme);
    ...
    <section className="flex max-w-lg flex-col gap-6">
      <div className="rounded-lg border-2 border-ink/10 bg-white p-4 text-sm">
        ...
        <ul className="flex flex-col gap-1 opacity-80">
          ...
          <li className="opacity-70">
            보기는 학습카드처럼 <b>급한 벽돌부터</b> 묶여 나와요 (첫 묶음 = 가장
            아래 벽돌의 보기)
          </li>
          <li>
