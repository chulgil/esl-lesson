...
| 상황 | 동작 |
|---|---|
| 접속 중 + 다른 화면 | 파비콘·탭 제목 배지 + 벨 배지 갱신 (미니 토스트 제거 — 2026-07-31) |
