...
> 2026-08-05 갱신: 여름 바다(ocean) 테마 신설 · XP 상점 신설

## XP 상점 (2026-08-05)

XP 로 제한 테마를 구매한다 — 업적 보상과 **독립 설정, 동시 사용 가능**
(같은 테마를 업적으로도 얻고 XP 로도 살 수 있다 — 사용자 결정).

| 항목 | 규칙 |
|---|---|
| 가격 | `theme_settings.price_xp` — 백오피스 테마 몰에서 입력, **NULL = 미판매** (보상 전용은 비워둔다) |
